...
var presets = {
  'None': { enabled: false, threshold: 0, knee: 30, ratio: 1, attack: .003, release: .25, boost: 0 },
  ...
  'High': { enabled: true, threshold: -40, knee: 30, ratio: 20, attack: .003, release: .25, boost: .5 }
};
